...
<head>
        ...
        <title>Exclusive Kasi Living - Data Tables</title>
            ...
            <div class="page-wrapper">
                <div class="content container-fluid">
					...
					<div class="page-header">
						<div class="row">
							<div class="col">
								<h3 class="page-title">Province</h3>
								<ul class="breadcrumb">
						...
						<div class="col-md-12">
							<div class="card">
								<div class="card-header">
									<h1 class="card-title">Add Province</h1>
									<?php echo $error;?>
									<?php echo $msg;?>
									<?php 
										if(isset($_GET['msg']))	
											...
											<div class="row">
												<div class="col-xl-6">
													...
													<div class="form-group row">
														<label class="col-lg-3 col-form-label">Province Name</label>
														<div class="col-lg-9">
